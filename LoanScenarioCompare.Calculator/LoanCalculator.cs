...
namespace LoanScenarioCompare.Calculator
{
    ...
    public class LoanCalculator : ILoanCalculator
    {
        ...
        public CalculationLoanRepayment CalculateRepaymentPerPeriod(Loan loan)
        {
            ...
            var rate = PeriodConverter.CovertPeriod(loan.Rate.PeriodType, loan.Rate.InterestPercentage / 100, loan.RepaymentPeriod.PeriodType);
            ...
            return new CalculationLoanRepayment { PeriodType = loan.RepaymentPeriod.PeriodType, RepaymentAmount = Convert.ToDecimal(repayment) };
        }
    }
}
